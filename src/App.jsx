    ...
    <>
      <div className="flex justify-center items-center bg-blueMain min-h-screen">
        <div className=" rounded-lg max-w-xs h-3/4 bg-blueCard shadow-lg p-4">
          ...
          <h1 className="font-semibold mb-3 text-lg">Equilibrum #3429</h1>
          <p className="font-light text-softBlue mb-3">Our Equilibruim collection promotes balance and calm</p>
          ...
          <div className="flex items-center">
            <img src="\image-avatar.png" width="30px" height="30px" alt="Avatar" className="border border-white rounded-3xl" />
           <p className="text-sm text-softBlue ml-3">Creation of <a href="#" className="text-white hover:text-cyan"> Jules Wyvern</a></p>
          </div>
          </div>
        </div>
      </div>
